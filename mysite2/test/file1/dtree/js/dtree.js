...
function dTree(objName) {
	...
	this.icon = {
		...
		root				: 'dtree/img/base.ico',

		folder			: 'dtree/img/folder.ico',

		folderOpen	: 'dtree/img/folderopen.ico',

		node				: 'dtree/img/page.ico',
...
dTree.prototype.node = function(node, nodeId) {
	...
	if (this.config.useIcons) {
		...
		str += '<img class="dTreeIcon" id="i' + this.obj + nodeId + '" src="' + ((node._io) ? node.iconOpen : node.icon) + '" alt="" />';
