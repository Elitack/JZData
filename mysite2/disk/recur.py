...
class MySpider(scrapy.Spider):
    ...
    def start_requests(self):
        pages = []
        f = open("/home/jack/Documents/Project/JZData/mysite2/disk/input.txt", "r")
        line = f.readline().replace('\n', '')
        #print line
        #print '\n'
        for filename in os.listdir(line):
            url = r"file://" + line.replace("%5C",'\\') + filename + "/Contents0.html"
            #print "--------------"
            #print url
            #print "--------------"
...
#Message
    ...
    def getRoute(self):
        pages = []
        f = open("/home/jack/Documents/Project/JZData/mysite2/disk/output.txt", "r")
        line = f.readline().replace('\n', '')
        return line
    ...
    def parseCallLog(self, response):
        ...
        for li in tablelist:
            ...
            while index < len(tdlist):
                f = file(route + 'file1' + '-' + "callLog.csv", "a+")
    ...
    def parseMessage(self, response):
        ...
        for li in tablelist:
            ...
            for trTmp in trlist[1:len(trlist)] :
                ...
                f = file(route + 'file1' + '-' + "Message.csv", "a+")
    ...
    def parseAdressBook(self, response):
        ...
        for li in tablelist:
            ...
            while index < len(tdlist):
                f = file(route + 'file1' + '-' + "adressBook.csv", "a+")
                f.write(tdlist[index] + ',' + tdlist[index+1] + ',' + tdlist[index+2] + ',')
